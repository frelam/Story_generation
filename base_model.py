...
class BaseModel(object):
    ...
    def eval(self, sess, eval_data, vocabulary):
        ...
        idx = 0
        for k in range(eval_data.num_batches):
    ...
    def test(self, sess, test_data, vocabulary):
        ...
        # Generate the captions for the images
        for k in range(test_data.num_batches):
    ...
    def load(self, sess, model_file=None):
        ...
        for v in tf.global_variables():
            if v.name in data_dict.keys():
                #if v.name not in  ['decode/fc_1/kernel:0','decode/fc_2/kernel:0','decode/fc_1/bias:0','decode/fc_2/bias:0','decode/fc_2/bias:0','word_embedding/weights:0','word_embedding/bias:0']:
